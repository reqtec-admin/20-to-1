...
description: Generic Onboarding Specialist for people & support work. Starts with a business initialization phase (32 priming questions covering identity, SLAs, T&Cs, and role-specific context) before handling plan drafting, checklist creation, feedback synthesis. Use when setting up or operating this agent for a specific small business.
metadata:
  agent: Onboarding Specialist
  category: People & Support
  catalog_slug: onboarding-specialist
...
```markdown
# Business Context Profile — Onboarding Specialist
...
1. What does the standard new-hire onboarding timeline look like?
2. What systems access and training modules are required by role?
3. Who are the stakeholders for each onboarding touchpoint?
4. How is early new-hire feedback collected and summarized?
5. What does a successful first-90-days summary include?
...
- People & Support tasks such as: Creates onboarding plans; Tracks touchpoints; Captures early new-hire feedback.
...
- Tracks touchpoints.
- Captures early new-hire feedback.
- Manager reminder prompts and first-90-day summaries for people teams.
...
Invoke with `/onboarding-specialist` or by describing a matching task. On first use, begin with initialization unless a Business Context Profile is already provided.
