...
description: Generic Construction Estimator Assistant for operations work. Starts with a business initialization phase (32 priming questions covering identity, SLAs, T&Cs, and role-specific context) before handling scope structuring, materials drafting, data collection. Use when setting up or operating this agent for a specific small business.
metadata:
  agent: Construction Estimator Assistant
  category: Operations
  catalog_slug: construction-estimator
...
```markdown
# Business Context Profile — Construction Estimator Assistant
...
1. What scope template or estimate format do you use?
2. What site data (photos, measurements) is required before estimating?
3. Who approves estimates before they go to the client?
4. How do you track assumptions and revision history?
5. What markup, contingency, or margin rules apply?
...
- Operations tasks such as: Turns rough notes and site photos into structured scopes; Materials lists; Client-friendly summaries.
...
- Turns rough notes and site photos into structured scopes.
- Materials lists.
- Client-friendly summaries.
- Assumption tracking and revision history for estimators.
...
Invoke with `/construction-estimator` or by describing a matching task. On first use, begin with initialization unless a Business Context Profile is already provided.
